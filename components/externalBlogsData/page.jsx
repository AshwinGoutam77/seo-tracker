...
export default function ExternalBlogsData({ keywords, onDelete, onUpdate, categories }) {
            ...
            <Table>
                <TableHeader>
                    <TableRow>
                        ...
                        <TableHead>Content For</TableHead>
                        <TableHead>Keyword</TableHead>
                        <TableHead>LSI Keywords</TableHead>
                        ...
                        keywords.map((keyword) => (
                            <TableRow key={keyword.id}>
                                {editingId === keyword.id ? (
                                    ...
                                    <>
                                        <TableCell className="font-medium">{keyword.topic}</TableCell>
                                        <TableCell>{keyword.keyword}</TableCell>
                                        <TableCell>{keyword.lsiKeyword}</TableCell>
                                        <TableCell>{keyword.title}</TableCell>
                                        <TableCell>{keyword.link}</TableCell>
                                        <TableCell>{keyword.quillbot}</TableCell>
                                        <TableCell>{keyword.zeroGpt}</TableCell>
                                        <TableCell>
