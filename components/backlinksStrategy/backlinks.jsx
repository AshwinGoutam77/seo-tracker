...
export default function BacklinkStrategyList({ keywords, onDelete, onUpdate, categories }) {
    ...
    return (
        <div className="border rounded-lg">
            <Table className='overflow-x-auto w-max'>
                <TableHeader>
                    <TableRow>
                        ...
                        <TableHead>Approved by Team</TableHead>
                        <TableHead>Approved by Customer</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                    {keywords.length === 0 ? (
                        ...
                        keywords.map((keyword) => (
                            <TableRow key={keyword.id}>
                                {editingId === keyword.id ? (
                                    ...
                                    <>
                                        <TableCell className="font-medium">{keyword.Activity}</TableCell>
                                        <TableCell>{keyword.Backlinks}</TableCell>
                                        <TableCell>{keyword.Keyword}</TableCell>
                                        <TableCell>{keyword.URL}</TableCell>
                                        ...
                                        <TableCell className='text-center'>
                                            <Input
                                                type='checkbox' checked={keyword.approvedByTeam}
                                                className='m-auto'
                                                onChange={() => onUpdate({ ...keyword, approvedByTeam: !keyword.approvedByTeam })}
                                            />
                                        </TableCell>
                                        <TableCell className='text-center'>
                                            <AlertDialog>
                                                ...
                                                <AlertDialogContent>
                                                    <AlertDialogHeader>
                                                        <AlertDialogTitle>Any Suggestions</AlertDialogTitle>
                                                        <AlertDialogDescription>
                                                            <Textarea placeholder="Enter your suggestions here..." rows={4} />
                                                        </AlertDialogDescription>
                                                    </AlertDialogHeader>
                                                    <AlertDialogFooter>
                                                        <AlertDialogCancel>Cancel</AlertDialogCancel>
                                                        <AlertDialogAction onClick={() => onDelete(keyword.id)}>Save</AlertDialogAction>
                                                    </AlertDialogFooter>
                                                </AlertDialogContent>
                                            </AlertDialog>
                                        </TableCell>
