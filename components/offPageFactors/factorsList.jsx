...
export default function FactorList({ keywords, onDelete, onUpdate, categories }) {
                        ...
                        keywords.map((keyword) => (
                            <TableRow key={keyword.id}>
                                {editingId === keyword.id ? (
                                    ...
                                    <>
                                        <TableCell className="font-medium">{keyword.Tasks}</TableCell>

                                        <TableCell>{keyword.Status}</TableCell>
                                        <TableCell>{keyword.Note}</TableCell>
                                        <TableCell>
